 ...
 *
 * Usage in Svelte (call during component initialization):
 *   useEscapeStack([
 ...
 *   ]);
 *
 * Note: `isOpen` is a getter function so it reads the current $state value
 * at key-press time rather than capturing a stale closure.
 */
