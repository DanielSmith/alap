        ...
        <CollapsibleContent>
          <div className="px-6 pb-6">
            ...
            <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
              <CollapsibleTrigger className="text-xs cursor-pointer select-none py-1 text-dim mt-2 mb-4">
            ...
            <div className="flex justify-between items-center pt-4" style={{ borderTop: '1px solid var(--alap-border-subtle)' }}>
              <Button variant="cancel" onClick={() => closeEditItem(itemId)} className="text-sm px-6 py-2 rounded-2xl font-medium">
                Cancel
              </Button>
