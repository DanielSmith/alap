...
modified: '2026-04-25T17:00:45Z'
title: Threat model
description: '> **A note on scope.** I''m not a security expert. Alap hasn''t been
  > through a third-party audit — it''s an open source project from a > single maintainer.
  Please do your own due diligence before >…'
---
# Threat model
...
[[api-reference/security|api-reference/security.md]].
