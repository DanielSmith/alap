---
source: framework-guides/qwik.md
modified: '2026-04-23T16:24:13Z'
tags:
- framework_guides
title: Qwik
description: '**Framework Guides:** Vanilla DOM · Web Component · React · Vue · Svelte
  · SolidJS · Astro · Alpine.js · Eleventy · **This Page**'
---
# Qwik

**[[framework-guides/README|Framework Guides]]:** [[framework-guides/vanilla-dom|Vanilla DOM]] · [[framework-guides/web-component|Web Component]] · [[framework-guides/react|React]] · [[framework-guides/vue|Vue]] · [[framework-guides/svelte|Svelte]] · [[framework-guides/solid|SolidJS]] · [[framework-guides/astro|Astro]] · [[framework-guides/alpine|Alpine.js]] · [[framework-guides/eleventy|Eleventy]] · **This Page**
...
- [[framework-guides/web-component|Web Component]] — `<alap-link>` (used by the integration)
- [[core-concepts/styling|Styling]] — CSS for menu appearance
- [[cookbook/placement|Placement]] — compass-based positioning guide
