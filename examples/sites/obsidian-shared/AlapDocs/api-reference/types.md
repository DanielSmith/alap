...
Interface for persistence backends. See [[api-reference/storage|Storage]].
...
|------|------|-------------|
| `Placement`, `PlacementStrategy`, `PlacementInput`, `PlacementResult` | [[api-reference/placement|Placement]] | Compass positioning and strategies |
| `AlapLightboxOptions` | [[api-reference/lightbox|Lightbox]] | Lightbox constructor options |
| `AlapLensOptions` | [[api-reference/lens|Lens]] | Lens constructor options (transitions, meta labels, copy) |
| `EmbedType`, `EmbedPolicy`, `EmbedProvider`, `AlapEmbedOptions` | [[api-reference/embeds|Embeds]] | Embed rendering and consent |
| `RendererType`, `OpenPayload`, `CoordinatedRenderer`, `RendererCoordinatorOptions` | [[api-reference/coordinators|Coordinators]] | Renderer transitions and cross-instance dismiss |
