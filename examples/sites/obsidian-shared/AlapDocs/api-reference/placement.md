---
source: api-reference/placement.md
modified: '2026-04-15T15:42:57Z'
tags:
- api_reference
title: Placement API
description: '**API Reference:** Engine · Types · Storage · Events · Security · Servers
  · **This Page** · Lightbox · Lens · Embeds · Coordinators · Config Registry'
---
# Placement API

**[[api-reference/README|API Reference]]:** [[api-reference/engine|Engine]] · [[api-reference/types|Types]] · [[api-reference/storage|Storage]] · [[api-reference/events|Events]] · [[api-reference/security|Security]] · [[api-reference/servers|Servers]] · **This Page** · [[api-reference/lightbox|Lightbox]] · [[api-reference/lens|Lens]] · [[api-reference/embeds|Embeds]] · [[api-reference/coordinators|Coordinators]] · [[api-reference/config-registry|Config Registry]]

Pure-geometry placement engine. Positions menus, overlays, and panels relative to trigger elements without touching the DOM.

> See also: [[cookbook/placement|Cookbook: Placement]] for usage examples.
