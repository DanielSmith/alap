---
source: api-reference/spec.md
modified: '2026-04-15T15:42:57Z'
tags:
- api_reference
title: Expression Language Spec
description: '**API Reference:** **This Page** · Engine · Types · Events · Security
  · Servers'
---
# Expression Language Spec

**[[api-reference/README|API Reference]]:** **This Page** · [[api-reference/engine|Engine]] · [[api-reference/types|Types]] · [[api-reference/events|Events]] · [[api-reference/security|Security]] · [[api-reference/servers|Servers]]

Formal specification of the Alap expression language. For a tutorial introduction, see [[core-concepts/expressions|Expressions]].
