---
source: cookbook/markdown.md
modified: '2026-04-15T15:42:57Z'
tags:
- cookbook
title: Markdown, HTML & MDX Integration
description: '**Cookbook:** Language Ports · Editors · **This Page** · Rich-Text ·
  Accessibility · Existing URLs · Images & Media'
---
# Markdown, HTML & MDX Integration

**[[cookbook/README|Cookbook]]:** [[cookbook/language-ports|Language Ports]] · [[cookbook/editors|Editors]] · **This Page** · [[cookbook/rich-text|Rich-Text]] · [[cookbook/accessibility|Accessibility]] · [[cookbook/existing-urls|Existing URLs]] · [[cookbook/images-and-media|Images & Media]]
...
See [[framework-guides/eleventy|Eleventy]] for the full guide.
...
See [[integrations/wordpress|`plugins/wordpress/`]] for install instructions, Docker setup (SQLite, single container), and the instant demo.
