---
source: cookbook/lightbox.md
modified: '2026-04-15T15:42:57Z'
tags:
- cookbook
title: Lightbox Renderer
description: '**Cookbook:** Language Ports · Editors · Markdown · Rich-Text · Accessibility
  · Existing URLs · Images and Media · Placement · Lens Renderer · Embeds · **This
  Page**'
---
# Lightbox Renderer

**[[cookbook/README|Cookbook]]:** [[cookbook/language-ports|Language Ports]] · [[cookbook/editors|Editors]] · [[cookbook/markdown|Markdown]] · [[cookbook/rich-text|Rich-Text]] · [[cookbook/accessibility|Accessibility]] · [[cookbook/existing-urls|Existing URLs]] · [[cookbook/images-and-media|Images and Media]] · [[cookbook/placement|Placement]] · [[cookbook/lens|Lens Renderer]] · [[cookbook/embeds|Embeds]] · **This Page**
...
Items without an image but with `meta.embed` show an iframe in the image area (see [[cookbook/embeds|Embeds]]). Items with neither show a text-only panel with a transparent card background.
