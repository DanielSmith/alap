---
source: cookbook/lens.md
modified: '2026-04-15T15:42:57Z'
tags:
- cookbook
title: Lens Renderer
description: '**Cookbook:** Language Ports · Editors · Markdown · Rich-Text · Accessibility
  · Existing URLs · Images and Media · Placement · Lightbox Renderer · Embeds · **This
  Page**'
---
# Lens Renderer

**[[cookbook/README|Cookbook]]:** [[cookbook/language-ports|Language Ports]] · [[cookbook/editors|Editors]] · [[cookbook/markdown|Markdown]] · [[cookbook/rich-text|Rich-Text]] · [[cookbook/accessibility|Accessibility]] · [[cookbook/existing-urls|Existing URLs]] · [[cookbook/images-and-media|Images and Media]] · [[cookbook/placement|Placement]] · [[cookbook/lightbox|Lightbox Renderer]] · [[cookbook/embeds|Embeds]] · **This Page**
...
If an item has `meta.embed`, the lens renders an iframe (or consent placeholder) in the meta zone, above the field list. The `embed` and `embedType` keys are filtered from the displayed fields. See [[cookbook/embeds|Embeds]] for full details on providers, policies, and security.
