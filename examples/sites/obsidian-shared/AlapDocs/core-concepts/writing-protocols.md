---
source: core-concepts/writing-protocols.md
modified: '2026-04-25T23:49:14Z'
tags:
- core_concepts
title: Writing a Protocol
description: '**Core Concepts:** Expressions · Macros · Search Patterns · Protocols
  · **This Page** · Refiners · Styling'
---
# Writing a Protocol

**[[core-concepts/README|Core Concepts]]:** [[core-concepts/expressions|Expressions]] · [[core-concepts/macros|Macros]] · [[core-concepts/search-patterns|Search Patterns]] · [[core-concepts/protocols|Protocols]] · **This Page** · [[core-concepts/refiners|Refiners]] · [[core-concepts/styling|Styling]]
...
The above is the floor. If your protocol does any of the following, you need additional defenses — see [[api-reference/security|Security]] and the [[security/threat-model|Threat model]]:
...
1. **[[core-concepts/protocols|protocols.md]]** — add a section describing the protocol, its sub-modes, and expression examples. Keep it to shipped behaviour only; planned sub-modes live in design docs.
...
13. **Document.** Update [[core-concepts/protocols|protocols.md]], add a worked example.
...
- [[core-concepts/protocols|Protocols]] — built-in protocol reference
- [[core-concepts/refiners|Refiners]] — how `*sort*`, `*limit*`, `*shuffle*` compose with your protocol
- [[api-reference/types|Types]] — `AlapProtocol`, `GenerateHandler`, `ProtocolHandler`
- [[api-reference/security|Security]] — the full security model for external fetches
