---
source: core-concepts/styling.md
...
**[[core-concepts/README|Core Concepts]]:** [[core-concepts/expressions|Expressions]] · [[core-concepts/macros|Macros]] · [[core-concepts/search-patterns|Search Patterns]] · [[core-concepts/protocols|Protocols]] · [[core-concepts/refiners|Refiners]] · **This Page**
...
For the full list of custom properties and `::part()` selectors, see [[framework-guides/web-component|Web Component]].
...
- [[framework-guides/web-component|Web Component]] — full list of CSS custom properties and `::part()` selectors
- [[framework-guides/vanilla-dom|Vanilla DOM]] — DOM adapter selectors and markup
