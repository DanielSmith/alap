---
source: core-concepts/expressions.md
modified: '2026-04-15T15:42:57Z'
tags:
- core_concepts
title: Expressions
description: '**Core Concepts:** **This Page** · Expression Spec · Macros · Search
  Patterns · Protocols · Refiners · Styling'
---
# Expressions

**[[core-concepts/README|Core Concepts]]:** **This Page** · [[api-reference/spec|Expression Spec]] · [[core-concepts/macros|Macros]] · [[core-concepts/search-patterns|Search Patterns]] · [[core-concepts/protocols|Protocols]] · [[core-concepts/refiners|Refiners]] · [[core-concepts/styling|Styling]]
...
For the full formal specification with operator semantics and worked input/output examples, see the [[api-reference/spec|Expression Spec]].

## Beyond selection

Expressions can also include [[core-concepts/protocols|protocol filters]] for dimensional queries (time, location, live data sources) and [[core-concepts/refiners]] for shaping results (sort, limit, shuffle). Together, the three phases — selection, gathering, and refining — give you full control over what appears and in what order.

## Next steps

- [[core-concepts/macros|Macros]] — name and reuse expressions
- [[core-concepts/search-patterns|Search Patterns]] — regex-based discovery
- [[core-concepts/protocols|Protocols]] — time, location, and custom dimensions
- [[core-concepts/refiners|Refiners]] — sort, limit, shuffle results
