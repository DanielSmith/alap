...
- getting_started
title: Installation
description: '**Getting Started:** **This Page** · Quick Start · Configuration'
---
# Installation

**[[getting-started/README|Getting Started]]:** **This Page** · [[getting-started/quick-start|Quick Start]] · [[getting-started/configuration|Configuration]]
...
For WordPress, see the [[integrations/wordpress|WordPress plugin]] (no npm — PHP plugin with Docker containers).
For Hugo, see the [[integrations/hugo|Hugo integration]] (shortcodes + web component).
