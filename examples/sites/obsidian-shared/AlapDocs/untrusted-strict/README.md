...
title: Untrusted-demo source — strict-default sanitisation
description: Three small sources, each demonstrating one strip category that's on
  by default in the converter. Useful for understanding what the tool does to content
  from a third-party feed, a collaborator's…
---
