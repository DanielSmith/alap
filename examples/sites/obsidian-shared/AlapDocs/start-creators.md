---
source: start-creators.md
modified: '2026-04-25T23:50:24Z'
title: Getting Started — Creators
description: This guide is for people who use Alap, not build it. You want to understand
  what Alap does, how the expression language works, and where to manage your links.
---
...
Patterns are defined in the config — you reference them by name. See [[core-concepts/search-patterns|Search Patterns]] for more.
...
The expression language also supports [[core-concepts/protocols]] that gather data dynamically — filtering by time, location, or pulling live results from external APIs and Bluesky — and [[core-concepts/refiners]] that sort, limit, and shuffle results. You don't need these to get started, but they're there when your queries outgrow tags.
...
|---------|---------------|
| [[cookbook/accessibility|Accessibility]] | Keyboard navigation, ARIA, screen readers |
| [[cookbook/editors|Editors]] | Setting up and using the visual editors |
| [[cookbook/existing-urls|Existing URLs]] | Preserving `href` when Alap enhances a link |
| [[cookbook/images-and-media|Images & Media]] | Image items, thumbnails, media in menus |
| [[cookbook/markdown|Markdown & CMS Content]] | Alap in markdown, MDX, and HTML from headless CMSs |
| [[cookbook/rich-text|Rich-Text Editors]] | Tiptap/ProseMirror integration |
| [[cookbook/placement|Placement]] | Compass-based menu positioning |
| [[cookbook/language-ports|Language Ports]] | Server-side ports in Rust, Python, Go, PHP |
