---
source: integrations/next.md
modified: '2026-04-15T15:42:57Z'
tags:
- integrations
title: next-alap
description: Next.js integration for Alap — `'use client'` component re-exports, a
  layout component, and an optional MDX config wrapper for the App Router.
---
# next-alap
...
- [[framework-guides/react|React adapter]] — the underlying component library (source: `src/ui/react/`)
