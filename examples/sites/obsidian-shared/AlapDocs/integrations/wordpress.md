---
source: integrations/wordpress.md
modified: '2026-04-15T15:42:57Z'
tags:
- integrations
title: Alap for WordPress
description: WordPress plugin that adds the `[alap]` shortcode for multi-target link
  menus. No npm, no build step — just a PHP file and the IIFE build.
---
# Alap for WordPress
