---
source: integrations/vitepress.md
modified: '2026-04-15T15:42:57Z'
tags:
- integrations
title: vitepress-alap
description: VitePress integration for Alap — use `` web components directly in your
...
Available in the [Alap monorepo](https://github.com/DanielSmith/alap) at `integrations/vitepress-alap/`.
...
- [[integrations/astro|Astro integration]] — similar pattern for Astro/Starlight
- [[integrations/qwik-city|Qwik City integration]] — similar pattern for Qwik
