---
source: integrations/eleventy.md
modified: '2026-04-15T15:42:57Z'
tags:
- integrations
title: eleventy-alap
description: Eleventy plugin for Alap — multi-target link menus for static sites.
---
# eleventy-alap
...
Available in the [Alap monorepo](https://github.com/DanielSmith/alap) at `integrations/eleventy-alap/`.
...
```json
"eleventy-alap": "file:../path-to-alap/integrations/eleventy-alap"
```
