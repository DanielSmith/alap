...
title: Vanilla source — no `--ssg` flag
description: Plain markdown. The simplest possible input — no shortcodes, no admonitions,
  no Liquid templating. A small listening journal about Bach. Body content is adapted
