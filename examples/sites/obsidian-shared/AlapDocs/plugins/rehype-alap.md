---
source: plugins/rehype-alap.md
modified: '2026-04-15T15:42:57Z'
tags:
- plugins
title: rehype-alap
description: Rehype plugin that transforms `` links into `` web components.
---
# rehype-alap
...
- [[plugins/remark-alap]] — the Markdown equivalent (`[text](alap:query)`)
