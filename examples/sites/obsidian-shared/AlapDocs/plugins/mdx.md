---
source: plugins/mdx.md
modified: '2026-04-15T15:42:57Z'
tags:
- plugins
title: '@alap/mdx'
description: MDX integration for Alap — transforms `text` links in MDX content into
  React `` components.
---
# @alap/mdx
...
Unlike [[plugins/remark-alap]] (which emits `<alap-link>` web component HTML), this plugin emits JSX that resolves through React's `AlapProvider` context. Use this when your MDX content renders inside a React component tree.
...
- [[plugins/remark-alap]] — web component output for non-React pipelines
- [[plugins/rehype-alap]] — transform `<a href="alap:query">` from headless CMSs
- [[cookbook/markdown|Markdown cookbook]] — patterns for Alap in content pipelines
- [[framework-guides/react|React adapter guide]] — `AlapProvider`, `AlapLink`, `useAlap()`
