...
export const demoConfig: AlapConfig = {
  ...
  macros: {
    ...
    everything: { linkItems: '.bridge, .park, .coffee, .landmark, .pokemon, .nasa' },
    gen1: { linkItems: 'charizard, eevee, snorlax, gengar' },
    apod: { linkItems: 'ngc1232, ngc1398, seahorse, geminids, comet12p' },
  },
  ...
  allLinks: {
    ...
    // --- Pokémon (from PokeAPI) ---

    charizard_lite: {
      label: 'Charizard (lite)',
      url: 'https://pokemondb.net/pokedex/charizard',
      tags: ['pokemon', 'fire', 'flying', 'gen1'],
      description: 'Spits fire that is hot enough to melt boulders.',
      thumbnail: '../shared/img/pokemon/charizard.png',
      meta: {
        types: ['Fire', 'Flying'],
    ...
    eevee: {
      label: 'Eevee',
      url: 'https://pokemondb.net/pokedex/eevee',
      tags: ['pokemon', 'normal', 'gen1'],
      description: 'Its genetic code is irregular. It may mutate if it is exposed to radiation from element stones.',
      thumbnail: '../shared/img/pokemon/eevee.png',
      meta: {
    ...
    snorlax: {
      label: 'Snorlax',
      url: 'https://pokemondb.net/pokedex/snorlax',
      tags: ['pokemon', 'normal', 'gen1'],
      description: 'Very lazy. Just eats and sleeps. As its rotund bulk builds, it becomes steadily more slothful.',
      thumbnail: '../shared/img/pokemon/snorlax.png',
      meta: {
    ...
    ngc1232: {
      label: 'NGC 1232: A Grand Design Spiral Galaxy',
      url: 'https://apod.nasa.gov/apod/ap240101.html',
      tags: ['nasa', 'apod', 'galaxy', 'deep_space'],
      description: 'Galaxies are fascinating not only for what is visible, but for what is invisible. Grand spiral galaxy NGC 1232, captured in detail by one of the Very Large Telescopes, is a good example.',
      thumbnail: 'https://apod.nasa.gov/apod/image/2401/ngc1232b_vlt_960.jpg',
      meta: {
        date: '2024-01-01',
        media_type: 'image',
        hd_url: ['https://apod.nasa.gov/apod/image/2401/ngc1232b_vlt_3969.jpg'],
        source: 'nasa',
    ...
    ngc1398: {
      label: 'Rings and Bar of Spiral Galaxy NGC 1398',
      url: 'https://apod.nasa.gov/apod/ap230712.html',
      tags: ['nasa', 'apod', 'galaxy', 'deep_space'],
      description: 'Spiral galaxy NGC 1398 not only has a ring of pearly stars, gas and dust around its center, but a bar of stars and gas across its center, and spiral arms that appear like ribbons farther out.',
      thumbnail: 'https://apod.nasa.gov/apod/image/2307/Ngc1398_Hanson_960.jpg',
      meta: {
        date: '2023-07-12',
        media_type: 'image',
        observatory: 'Observatorio El Sauce, Chile',
        distance: '65 million light years',
        constellation: 'Fornax (the Furnace)',
        hd_url: ['https://apod.nasa.gov/apod/image/2307/Ngc1398_Hanson_2752.jpg'],
        source: 'nasa',
        sourceLabel: 'NASA APOD',
      },
    },
    ...
    seahorse: {
      label: 'The Dark Seahorse in Cepheus',
      url: 'https://apod.nasa.gov/apod/ap230420.html',
      tags: ['nasa', 'apod', 'nebula'],
      description: 'Spanning light-years, this suggestive shape known as the Seahorse Nebula appears in silhouette against a rich, luminous background of stars.',
      thumbnail: 'https://apod.nasa.gov/apod/image/2304/Barnard-150_LRGB_HIGH-RES1024.jpg',
      meta: {
        date: '2023-04-20',
        media_type: 'image',
        catalog: 'Barnard 150 (B150)',
        distance: '1,200 light-years',
        constellation: 'Cepheus',
        photoCredit: 'Jeff Herman',
        hd_url: ['https://apod.nasa.gov/apod/image/2304/Barnard-150_LRGB_HIGH-RES.jpg'],
        source: 'nasa',
        sourceLabel: 'NASA APOD',
      },
    },
    ...
    geminids: {
      label: 'Geminids and the Mittens',
      url: 'https://apod.nasa.gov/apod/ap221225.html',
      tags: ['nasa', 'apod', 'meteor'],
      description: 'Asteroid 3200 Phaethon\u2019s annual gift to planet Earth always arrives in December. Otherwise known as the Geminid meteor shower, the source is dust shed along the orbit of the mysterious asteroid.',
      thumbnail: 'https://apod.nasa.gov/apod/image/2212/J7A6402-Edit-copy-sharpened1024.jpg',
      meta: {
        date: '2022-12-25',
        media_type: 'image',
        event: 'Geminid meteor shower',
        location: 'Monument Valley, American Southwest',
        radiant_constellation: 'Gemini',
        notable_stars: ['Castor (blue)', 'Pollux (yellow)'],
        photoCredit: 'Chuck Derus',
        hd_url: ['https://apod.nasa.gov/apod/image/2212/J7A6402-Edit-copy-sharpened.jpg'],
        source: 'nasa',
        sourceLabel: 'NASA APOD',
      },
    },
    ...
    comet12p: {
      label: 'The Changing Ion Tail of Comet Pons-Brooks',
      url: 'https://apod.nasa.gov/apod/ap240408.html',
      tags: ['nasa', 'apod', 'comet'],
      description: 'The ion tail of Comet 12P/Pons\u2013Brooks has been changing markedly. On some days the tail was relatively long and complex, but not every day.',
      thumbnail: 'https://apod.nasa.gov/apod/image/2404/Comet12pTails_ShengyuLi_960.jpg',
      meta: {
        date: '2024-04-08',
        media_type: 'image',
        designation: '12P/Pons\u2013Brooks',
        observation_period: 'March 6\u201314, 2024',
        event: 'Visible during total solar eclipse',
        photoCredit: 'Shengyu Li & Shaining',
        hd_url: ['https://apod.nasa.gov/apod/image/2404/Comet12pTails_ShengyuLi_3000.jpg'],
        source: 'nasa',
        sourceLabel: 'NASA APOD',
      },
    },
