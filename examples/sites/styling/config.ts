...
export const stylingConfig: AlapConfig = {
  ...
  allLinks: {
    ...
    sfphoto: {
      ...
      image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/San_Francisco_from_the_Marin_Headlands_in_March_2019.jpg/320px-San_Francisco_from_the_Marin_Headlands_in_March_2019.jpg',
      altText: 'San Francisco skyline',
      tags: ['sf', 'photo'],
    },
    nycphoto: {
      label: 'New York City',
