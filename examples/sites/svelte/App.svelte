...
<script lang="ts">
  ...
  import ComposableExample from './ComposableExample.svelte';
  import DynamicConfigExample from './DynamicConfigExample.svelte';
  import { demoConfig } from './config';
</script>

<AlapProvider config={demoConfig}>
  <h1>Alap v3 — Svelte Adapter</h1>
  <p>
    All examples use <code>&lt;AlapProvider&gt;</code> +
    <code>&lt;AlapLink&gt;</code> from <code>alap/svelte</code>.
  </p>
