...
**[Cookbook](README.md) › Obsidian:** [Overview](obsidian-overview.md) · [Get a Vault](obsidian-vault.md) · **Core Mode** · [REST Setup](obsidian-rest-setup.md) · [Hardening](obsidian-hardening.md)
...
If you don't have a vault yet, see [Get a Vault](obsidian-vault.md) first.
...
Two features that make tagged-note workflows more ergonomic. Both apply to Core *and* [REST](obsidian-rest-setup.md) — consumers get the same emitted tags regardless of sub-mode.
...
See [Overview — General troubleshooting](obsidian-overview.md#general-troubleshooting) for issues that apply to both modes (module not found, vault name mismatch, images not loading).
...
→ [REST Setup](obsidian-rest-setup.md) if you also want fuzzy search via the Local REST API plugin.
→ [Hardening](obsidian-hardening.md) if you're shipping this past a personal dev box.
