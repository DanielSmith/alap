...
**[Cookbook](README.md) › Obsidian:** [Overview](obsidian-overview.md) · [Get a Vault](obsidian-vault.md) · [Core Mode](obsidian-core.md) · [REST Setup](obsidian-rest-setup.md) · **Hardening**
...
- [REST Setup](obsidian-rest-setup.md) — installing the Local REST API plugin and wiring it to Alap
- [Core Mode](obsidian-core.md) — filesystem-only sub-mode
- [Security reference](../api-reference/security.md) — full per-feature security model
- [Threat model](../security/threat-model.md) — what the library does, doesn't do, and assumes from integrators
