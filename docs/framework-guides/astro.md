...
**[Framework Guides](README.md):** [Vanilla DOM](vanilla-dom.md) · [Web Component](web-component.md) · [React](react.md) · [Vue](vue.md) · [Svelte](svelte.md) · [SolidJS](solid.md) · **This Page** · [Alpine.js](alpine.md) | [All docs](../README.md)
...
Since the Astro adapter renders `<alap-link>` web components, styling works the same way — `--alap-*` custom properties and `::part()` selectors. See [Web Component](web-component.md) for the full CSS reference.
